...
model = AutoModelForSeq2SeqLM.from_pretrained("Enoch/llama-7b-hf")
...
def parse_arge():
    ...
    parser.add_argument("--model_id", type=str, default="Enoch/llama-7b-hf", help="Model id to use for training.")
...
def training_function(args):
    ...
    training_args = Seq2SeqTrainingArguments(
        ...
        push_to_hub=False, #True if args.repository_id else False,
