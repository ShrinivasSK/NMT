...
def main():
        ...
        for lg in oscar_langs:
            train_raw_data.append(
                load_dataset(
                    ...
                    lg,
                    cache_dir=model_args.cache_dir,
                    use_auth_token="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",
                    streaming=data_args.streaming,
                )['train']
            )
    ...
    tokenizer = load_tokenizer(data_args, model_args, training_args, logger)#use_auth_token="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")
    ...
    ## Load model
    model = load_model(data_args, model_args, training_args, tokenizer, logger)#use_auth_token="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")
